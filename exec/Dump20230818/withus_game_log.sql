...
CREATE TABLE `game_log` (
  `gamelog_id` bigint NOT NULL,
  `end_date` varchar(255) DEFAULT NULL,
  `start_date` varchar(255) DEFAULT NULL,
  `room_id` bigint DEFAULT NULL,
  PRIMARY KEY (`gamelog_id`),
  KEY `FKp2jsxyoul1iti8648p7msob2r` (`room_id`),
  CONSTRAINT `FKp2jsxyoul1iti8648p7msob2r` FOREIGN KEY (`room_id`) REFERENCES `room` (`room_id`) ON DELETE CASCADE
...
-- Dump completed on 2023-08-18 10:37:21
