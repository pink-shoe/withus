...
public class GameController {
    ...
    @ApiOperation(value = "사진 저장", notes = "모든 라운드 종료 후 유저는 저장하고 싶은 사진을 선택해 앨범에 저장한다.")
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "사진 저장 성공", examples = @Example(value = @ExampleProperty(mediaType = "application/json", value = "ok"))),
        @ApiResponse(code = 400, message = "사진 저장 실패", examples = @Example(value = @ExampleProperty(mediaType = "application/json", value = "{ \n errorCode: 400, \n message: fail \n}")))
    })
